...
model_config = mlflow.models.ModelConfig(development_config='/Workspace/Repos/merve.karali@databricks.com/databricks-field-genai/solutions/large-document-rag/rag_chain_config.yaml')
